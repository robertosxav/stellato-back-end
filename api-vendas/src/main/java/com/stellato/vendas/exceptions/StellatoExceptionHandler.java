package com.stellato.vendas.exceptions;
...
import com.stellato.vendas.exceptions.vo.DetalhesErro;
...
public class StellatoExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		List<com.stellato.vendas.exceptions.vo.DetalhesErro> erros = Arrays.asList(DetalhesErro.builder().addMsgUsuario(mensagemUsuario)
