...
CREATE TABLE orcamento_eletrico (orcamento_eletrico_id smallint NOT NULL , lead_id smallint NOT NULL , orcamento_eletrico_titulo VARCHAR(100) NOT NULL , orcamento_eletrico_observacao VARCHAR(1000) NOT NULL ,orcamento_eletrico_observacao_int VARCHAR(1000) NOT NULL , orcamento_eletrico_validade_propo smallint NOT NULL , orcamento_eletrico_prazo_entrega smallint NOT NULL , orcamento_eletrico_distancia smallint NOT NULL , orcamento_eletrico_detalhes_propo VARCHAR(1000) NOT NULL , orcamento_eletrico_tipo_instalacao smallint NOT NULL , orcamento_eletrico_tipo_estrutura smallint NOT NULL , etapas_funil_id smallint NOT NULL , orcamento_eletrico_status smallint NOT NULL, orcamento_eletrico_criado_em date NOT NULL, orcamento_eletrico_criardo_por smallint ,PRIMARY KEY(orcamento_eletrico_id));
